  ...
  return (
    <div
      className={`cursor-pointer w-fit p-1 rounded-lg text-white font-bold text-center ${
        isLoggin ? "bg-sky-700" : "bg-sky-500"} shadow-md hover:scale-105 transition-all ease-in-out duration-200 active:scale-100 flex items-center justify-center px-3`}
